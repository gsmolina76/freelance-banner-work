...
function adVisibilityHandler() {
	...
	var conditionalCollapse = function(){
		if(allowCollapse) {
			...
			TweenLite.to('#legal',.5,{scrollTo:{y:0}});
			toggleIsi();
...
var expandIsi = function(){
	...
	document.getElementById("bottom").style.animation = 'fade-left .5s forwards 0s 1';
	document.getElementById("bottom").style.WebkitAnimation = 'fade-left .5s forwards 0s 1';
...
var toggleIsi = function(){
	...
	if(isiIsExpanded) {
		...
		document.getElementById("bottom").style.animation = 'fade-right .5s forwards 0s 1';
		document.getElementById("bottom").style.WebkitAnimation = 'fade-right .5s forwards 0s 1';
