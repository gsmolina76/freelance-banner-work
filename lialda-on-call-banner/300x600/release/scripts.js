...
function adVisibilityHandler() {
	...
	animationTimeline
		...
		.to('#oncall',.25,{autoAlpha:0,x:-100},'res')
			// f1
		.fromTo('#f1',.5,{opacity:1,x:400},{x:30},'f1')
		.to('#f1',.5,{opacity:0},'f5-=0.5','f3-=.5')
		.fromTo('#f2',.5,{opacity:1,x:400},{x:30},'f1')
		...
		.to('#f4',.25,{x:-100,autoAlpha:0},'f5-=0.25')
			// f5
		.fromTo('#f5',.5,{autoAlpha:1,x:400},{x:0},'f5')
		.fromTo('#learn_more',.5,{autoAlpha:1,x:400},{autoAlpha:1,x:0},'f5')
	;
...
var collapseIsi = function(){
	...
	legalScroll.set({trackSize:162}).autoKill();
	isiIsExpanded = false;
}
